...
exports.RecentController = void 0;
...
let RecentController = class RecentController {
    ...
    create(createRecentDto) {
        return this.recentService.create(createRecentDto);
    }
    findAll() {
        return this.recentService.findAll();
    }
    findOne(id) {
        return this.recentService.findOne(+id);
    }
    remove(id) {
        return this.recentService.remove(+id);
    }
};
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:paramtypes", [create_recent_dto_1.CreateRecentDto]),
    __metadata("design:returntype", void 0)
], RecentController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], RecentController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], RecentController.prototype, "findOne", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RecentController.prototype, "remove", null);
...
//# sourceMappingURL=recent.controller.js.map