...
RecentModule = __decorate([
    (0, common_1.Module)({
        controllers: [recent_controller_1.RecentController],
        providers: [recent_service_1.RecentService, recent_gateway_1.RecentGateway],
        imports: [typeorm_1.TypeOrmModule.forFeature([recent_repository_1.RecentRepository])],
        exports: [recent_gateway_1.RecentGateway, recent_service_1.RecentService]
    })
], RecentModule);
