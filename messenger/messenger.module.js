...
MessengerModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [messenger_service_1.MessengerService, messenger_repository_1.MessengerRepository],
        imports: [typeorm_1.TypeOrmModule.forFeature([messenger_entity_1.Messenger]), user_module_1.UserModule]
    })
], MessengerModule);
